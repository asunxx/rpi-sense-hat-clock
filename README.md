...
a clock display on a 8×8 color dot matrix with time that is readable
...
Raspberry Pi OS / Raspbian operating system software,
and the ```sense-hat``` package (usually pre-installed).
```
$ uname -a
